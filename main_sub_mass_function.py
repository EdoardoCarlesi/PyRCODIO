...
def extract_sub_mass_function():
    '''
    Read the halo catalogs and extract the mass functions and MAHs for halos around a given center
    This is used for high resolution simulations
    '''
...
if __name__ == "__main__":
    ...
    # These variables are shared among all the subroutines
    global model_run
    global dict_model
    global code_run
    global sub_run
