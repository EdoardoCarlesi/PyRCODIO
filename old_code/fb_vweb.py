...
fig_ev1 = 'dist_ev1'
ax = plt.gca()
ax.set_xlabel('$\lambda_1$', size=size_lab1)
ax.set_ylabel('', size=size_lab1)
ax.axis([x_min, x_max, y_min, y_max])
#, y_min, y_max])
#ax.set_ylabel('$n( < \\tau _F)$')
#plt.title('Formation time MW')
plt.xticks(size = size_lab2)
plt.yticks(size = size_lab2)
plt.tight_layout()
plt.savefig(fig_ev1)
plt.clf()
plt.cla()
...
fig_ev2 = 'dist_ev2'
ax = plt.gca()
ax.set_xlabel('$\lambda_2$', size=size_lab1)
ax.set_ylabel('', size = size_lab1)
ax.axis([x_min, x_max, y_min, y_max])
#ax.axis([x_min, x_max, y_min, y_max])
#ax.set_ylabel('$n( < \\tau _F)$')
...
fig_ev3 = 'dist_ev3'
ax = plt.gca()
ax.set_xlabel('$\lambda_3$', size=size_lab1)
ax.set_ylabel('', size=size_lab1)
ax.axis([x_min, x_max, y_min, y_max])
#ax.set_ylabel('$n( < \\tau _F)$')
#plt.title('Formation time MW')
